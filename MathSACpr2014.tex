...
%   - migrate all recommendations to section 8?
	...
	{% if the total number of sections for this chapter is DEFINED
		...
		\begin{tikzpicture}[
			...
			\foreach \i in {1,2,...,\mymax}
			{
				...
				\else
                \node[draw=gray!50,fill=gray!50] at (\pgfmathresult:0.9cm)  {\@Alph{\i}};
				\fi
			}
		\end{tikzpicture}%
        \hskip 9pt
...
%    colback=yellow!10!white,colframe=black!50!yellow,%colframe=red!50!black,
%    before=\par\bigskip\noindent,
...
{%                  % numbered format
\llap{\color{black}\large\thecontentslabel\hskip .2cm}\large\sc%
}%
{\large\sc}         % unnumbered format
