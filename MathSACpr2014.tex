...
%  I keep going back to the TOC to start each batch of work, and each time the
%  TOC always starts on page 6 with the glossary.  Do you maybe want to start
%  with TOC as page 2?  As with all such non-typo related comments, this is your
%  call to make; my job is to just keep you thinking
...
\fixthis{Some references have no author field, but do have an institution. Currently, only the title of the item is printed, not the institution too. The answers here suggest we may have work to do if we want to use the institution field: http://tex.stackexchange.com/questions/65449/show-all-available-fields-in-references }
