...
\usepackage[backend=biber, style=numeric-comp]{biblatex}   % for the bibliography
...
\addbibresource{MathSACpr2014.bib} 
...
\titlepic{\includegraphics[width=\textwidth]{./graphics/50th_mathematicsproof}}
...
\include{appendices/dlsurveysummary}
