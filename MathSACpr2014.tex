	...
	{% if the total number of sections for this chapter is DEFINED
		...
		\begin{tikzpicture}[scale=0.8]
			...
			\foreach \i in {1,2,...,\mymax}
			{
                ...
                \node[draw,fill=white,double,circle,minimum width=0.5cm] at (\pgfmathresult:1.0cm)  {\bfseries\@Alph{\i}};
				\else
                \node[draw=gray!50,text=gray!50,fill=white,circle,minimum width=0.5cm] at (\pgfmathresult:1.0cm)  {\@Alph{\i}};
				\fi
			}
		\end{tikzpicture}%
        \hskip 9pt
