...
\newglossaryentry{MML}{name=MyMathLab,description={MyMathLab: a commercial computer-based homework management system owned and distributed by Pearson \url{http://www.pearsonmylabandmastering.com/northamerica/mymathlab/}}}
\newglossaryentry{MSL}{name=MyStatsLab,description={MyStatsLab: a commercial computer-based homework management system owned and distributed by Pearson \url{http://www.pearsonmylabandmastering.com/northamerica/mystatslab/}}}
...
%   - check colons and semi-colons surrounding bullets
%   - do we want a different bibliography style- something more descriptive?
%   - should seasons be capitalized or not?
