...
\begin{itemize}
  ...
  development of said systems targeted to our students (see \cpageref{sec3:subset:alekspilot}
  );
...
illustrates the new pathway is shown in \vref{app:sec:pathways}.
...
Not coincidentally, the math SAC met on January 17th in part to discuss the grant
proposal.  At the end of that meeting the math SAC, without a single no-vote,
passed the following recommendations.

\recommendation{The Math SAC endorses the draft outline of the NSF-IUSE grant
...
\recommendation{Regardless of the final design of the DE mathematics pathways,
memebrs of the math SAC should continue to work with members of the CG SAC to
...
\section[Changes resulting from the last program review]{Were any of the changes made as a result of the last review? If so,
