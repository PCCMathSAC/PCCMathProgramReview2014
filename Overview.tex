...
as noted.
\begin{description}
  \item[Discontinue MTH 231 and MTH 232 our discrete mathematics courses]   The
    mathematics SAC, in the Spring of 2009, voted to discontinue offering MTH
  ...
  \item[Created MTH 84] In the Fall of 2010 a pilot course was created to provide
    ...
    approved to make the course permanent (MTH 84) and we continue to run one
  ...
  \item[Creation of Co-chairs] At Cascade, Rock Creek and Sylvania campuses we
    offer between 100 to 150 class offerings per term, depending on campus, and
    thus require a large adjunct faculty pool to run these courses.    The
  ...
  \item[Use of WeBWorK] To further increase student accessibility and lower costs,
    ...
    software is an online homework system, or testing
    system that can provide feedback to the student.   Spearheaded by Alex
    Jordan faculty have been working on creating databases that fit our current
    curriculum, and it is currently being used by several faculty in courses
    offered at PCC.  The advantage to the student is that it is free and it is
    accessible to students with disabilities.   The advantage to faculty is that
  ...
  \item[Social Justice workgroup] Four math faculty attended the conference
    ...
    and where inspired to form an ongoing group of math faculty to create
...
different parts of this document, notaby \vref{chap:otherissues}.
...
The last PR (\cite{mathprogramreview2003}, pages 30-31) made suggestions related to faculty contact with
