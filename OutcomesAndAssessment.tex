...
OutComes Mapping matrix.  For example, through a long sequence of courses, if
the outcome level in the terminal course is a 4, should a 4 also be assigned to
the prerequisite courses or should the outcome levels build as the ``student
