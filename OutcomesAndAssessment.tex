...
However, we are fortunate to have math faculty involved with the Learning Assessment Council (LAC) and the Curriculum Committee. This involvement has kept our SAC aware of the college?s ongoing discussions regarding a possible future change for the focus of course-level learning outcomes  (i.e., expectation of measurability) and related accreditation standards (e.g., NWCCU Standard 4.A.3).\fixthis{REF}
...
\subsection{Describe how each of the College Core Outcomes are addressed in courses, and/or aligned with program and/or course outcomes.}\fixthis{this link was part of the subsection but its inclusion screws up the toc file. Not sure what to do.}\url{http://www.pcc.edu/resources/academic/core-outcomes/index.html}
...
\begin{quote}\fixthis{make a good way to attribute the quotes to the courses without making the courses be in the quote}
...
\item[Community and Environmental Responsibility] is not directly addressed in our courses or outcomes. Please see *** to read about how individual instructors address this outcome through our Social Justice Workgroup. \fixthis{REF: appendix, other occurrences of SJW. Also Ronda's 111H section}
...
\item use of mathematics as an agent of social change by shining a light on inequity with regard to treatment of, and resource allocation for, marginalized populations as compared to the dominant culture (the social justice workgroup considers this \fixthis{link to the work?})
\end{itemize}
...
\begin{itemize}
\item The direct assessment involved finding and correcting conceptual, arithmetic and formatting mistakes in expected procedural skills for MTH 65 and MTH 95.  The ``find and correct''\fixthis{someone who was involved with this should make this sentence make sense} is requires the students to know how to do the problem and to evaluate what was incorrect.  This is a higher-order skill on Bloom?s Taxonomy. 
...
\begin{enumerate}
\item Reflection -- Core reflective thinking items (autonomy and relatedness aspects from self-determination theory (Self Determination Theory;  Deci \& Ryan, 2009)\fixthis{REF}
