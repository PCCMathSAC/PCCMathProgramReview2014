...
\fixthis{This method of linking to the full reports is less than ideal. Many times below, there is a want to reference the full report. And so what do you do? Just say "...in the full report.."? Give the url again? Refer to the beginning of this section where the links are?}
\begin{description}
