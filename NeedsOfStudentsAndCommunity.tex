...
different educational backgrounds. \Cref{cur:sec:other} contains information on
...
We recommend that students who are not academically prepared be required to
...
underprepared students who returned to school after the recession.
...
response---the report can be viewed in full in \vref{app:sec:classsize}.
...
large number of underprepared students who entered the institution as a result
...
We offer MTH 07/08 (aka AMP) to returning students who are not happy with their
...
support and the collaborative nature of the project. The full text of the
...
On another note, there had been growing concern among several faculty members
about the nature of many accommodations.  Some of the accommodations that
caused concern had to do with things like calculator usage that completely
contradict assessment criteria stated in course CCOGs.  Another  concern were
accommodations that require flexibility in due dates (which can lead to the
withholding of keys for other students).  Kaela Parks came to a mathematics SAC
meeting to discuss these concerns, and she assured us that these accommodations
only need to be applied in reasonable ways.  She also said that affected
...
math requirement.  Of concern at PCC, other academic institutions, and
officials in the State of Oregon is the benefit gained by taking courses meant
for the general student population.  Current issues involve: should PCC create
