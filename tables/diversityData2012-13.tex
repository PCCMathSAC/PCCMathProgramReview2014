...
\pgfplotstableread[col sep=comma]{../data/demographics/demographics2012-2013.csv}\diversitydata
...
every row no 3/.style={after row=\cmidrule{2-72}},
every row no 13/.style={after row=\cmidrule{2-72}},
