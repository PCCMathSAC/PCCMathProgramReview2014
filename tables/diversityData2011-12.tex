...
\pgfplotstableread[col sep=comma]{../data/demographics/demographics2011-2012.csv}\diversitydata
...
every row no 3/.style={after row=\cmidrule{2-35}},
every row no 12/.style={after row=\cmidrule{2-35}},
