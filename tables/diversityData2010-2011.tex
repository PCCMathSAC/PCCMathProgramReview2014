...
\pgfplotstableread[col sep=comma]{../data/demographics/demographics2010-2011.csv}\diversitydata
...
every row no 3/.style={after row=\cmidrule{2-85}},
every row no 12/.style={after row=\cmidrule{2-85}},
