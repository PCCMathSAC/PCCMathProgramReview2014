a.% arara: pdflatex: {files: [MathSACpr2014]}
...
\recommendation{The college should continue to add new full-time math positions so that at each campus full-timers at least 40\% of all sections at both the DE and transfer level.}
