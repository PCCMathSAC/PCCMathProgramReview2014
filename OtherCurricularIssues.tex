...
\Cref{tab:sec3:F2FandDLdata2007,tab:sec3:F2FandDLdata2010} give more detailed data-- 
...
% I am not sure how well this has been communicated to the Math SAC, but Math
% 20 will no longer be offered as a DL course except for Diane Edwards' and
% Marilyn Marshall (I'm sorry but I don't know who this is)'s classes at RC.
% Apparently they have a strong track record for success among students who
% took Math 20 DL, and they were allowed to continue offering the course
% online.  This has not been widely advertised as I understand it because
% neither SY nor CA offer math 20 online anyway, and Carl Yao has other things
% to teach at SE besides that class. and apparently the exception was granted
% for RC.  Anyway, it seems like this partial moratorium on math 20 DL should
% be at least mentioned in this section, since it was a big deal to Chris
% Chairsell that we back out of math 20 online (though again not a big deal to
% SY or CA, since we already had the sense to do so long before).
...
\item \recommendation{Consider how the quality of online courses could be regulated more. }
\end{itemize}
...
\fixthis{comment below}
% In fact there is a meeting in the coming weeks to address exactly this issue
% (of HS math instructors not qualified to teach dual credit).  The proposal,
% as I understand it, is to create a team teaching paradigm where a PCC
% instructor is the instructor of record for the HS teacher.  You should
% probably add this, along with any professional concerns you might have about
...
% This sentence is awful.  There.  I said it.  Try ``The Math SAC is currently
% engaged in reevaluating and reorganizing pre-college level math at all levels
% in order to improve the alignment of course content to student needs for that
% content, and thereby to improve student success rates at every step along the
% math pipeline.  Specific topics will be shifted significantly across the
% newly designed courses, and content delivery will be changed dramatically.
% While students will be asked to take fewer pre-college level math courses, it
% is highly likely that the first course will require 5 credits for optimal
% student success.''  FWIW, I have dropped this bomb on Kurt already, and I
% didn't hear a word of objection from him.
