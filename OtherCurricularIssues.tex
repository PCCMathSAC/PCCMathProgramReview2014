...
\begin{table}[!htb]
  \begin{widepage}
    \centering
  	\caption{DL \& F2F enrollments and pass rates 2007--2010}\label{tab:sec3:F2FandDLdata2007-2010}
          %\input{tables/dlvsF2FenrollPass.tex}
          \input{tables/dlvsF2FenrollPass2007-2010.tex}
          \vspace{1cm}
  	\caption{DL \& F2F enrollments and pass rates 2010--2013}\label{tab:sec3:F2FandDLdata2010-2013}
          %\input{tables/dlvsF2FenrollPass.tex}
          \input{tables/dlvsF2FenrollPass2010-2013.tex}
  \end{widepage}
\end{table}
\fixthis{it would be great if we could separate this table and figure with some text}
...
\section[Other significant curricular changes]{Identify and explain any other significant curricular changes that have been made since the last review.}
