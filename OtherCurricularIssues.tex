...
\item \recommendation[Math SAC, DL, Advising]{Give students more information on
  DL responsibilities and make students
  aware of the difference in student-success statistics between DL and face to
  face courses.}
\item \recommendation[Math SAC, DL, Advising]{Encourage students to contemplate
...
\item \recommendation[Math SAC, Division Deans, DOIs]{Provide opportunities for faculty professional development in research
  ...
  online homework.}
\item \recommendation[Math SAC, Division Deans, DOIs, Advising, CIC]{Provide
...
\recommendation[Math SAC, DOIs, DOSs, Advising, CIC]{We recommend using the ALC
