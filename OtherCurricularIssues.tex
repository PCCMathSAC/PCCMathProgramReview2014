...
For more information on research by Instructors Bernards and Fresh, see \vref{app:sec:onlinehwstudy}. For information on research by instructors Edwards and Louie, see \vref{app:sec:aleks}. 
...
\begin{sidewaystable}
	...
	\input{tables/dlvsF2FenrollPass}
\end{sidewaystable}

\fixthis{Alex- maybe you want this table split into two? if we split it, we might not have to rotate it}
