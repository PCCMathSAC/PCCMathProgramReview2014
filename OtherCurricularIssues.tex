...
\recommendation[DL, Advising]{Our main recommendations concern how to best inform students about the
...
\begin{itemize}[label={}]
\item \recommendation[Math SAC]{Collaborate with advising to implement a WeBWorK-based review mechanism
...
\begin{itemize}[label={}]
\item \recommendation[Math SAC, DL, Advising]{Collaborate with the Math SAC to implement a WeBWorK-based review
  mechanism for would-be placement test-takers.}
\item \recommendation[Math SAC, DL, Advising]{Give students more information on DL responsibilities and make students
  aware of the difference in student-success statistics between DL and face to
  face courses.}
\item \recommendation[Math SAC, DL, Advising]{Encourage students to contemplate why they seek to take a DL course and
  reflect upon whether it will align well with their learning style and
  personal skill sets.}
\end{itemize}
\item For Administration/DL/TSS:
\begin{itemize}[label={}]
\item \recommendation[DL, TSS]{Have the online orientation linked from the registration tool in MyPCC and
  require that students complete this orientation before registering for a DL
  class.}
\item \recommendation[Math SAC, DL, Advising]{Include a section in the DL orientation that addresses the specific
...
\item \recommendation[Math SAC, Division Deans, DOIs]{Provide opportunities for faculty professional development in research
  design and data analysis to help with research efforts on the efficacy of
  online homework.}
\item \recommendation[Math SAC, Division Deans, DOIs, Advising, CIC]{Provide support for further development of WeBWorK related projects,
...
\recommendation[Math SAC, DOIs, DOSs, Advising, CIC]{We recommend using the ALC math classes as an early intervention when students fail math classes.}
