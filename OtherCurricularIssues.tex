...
\item \recommendation[Math SAC, Division Deans, DOIs]{Provide opportunities for faculty professional development in research
  ...
  online homework.}
\item \recommendation[Math SAC, Division Deans, DOIs, Advising]{Provide support for further development of WeBWorK related projects,
...
\recommendation[Math SAC, DOIs, DOSs, Advising]{We recommend using the ALC math classes as an early intervention when students fail math classes.}
