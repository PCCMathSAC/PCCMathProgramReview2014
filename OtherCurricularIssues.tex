...
\fixthis{a table needs to go here with more detailed DL enrollment data by term, year, and course for courses with DL offerings}
...
Pass rates in DL courses are quite noticeably lower than those for their face-to-face counterparts. \Cref{fig:sec3:F2FandDLpassRates} shows the difference in pass rates between the DL courses that we offer and their face-to-face counterparts. We recognize that students need a certain level of self-discipline, better study skills, and comfort engaging with technology to succeed in a DL course. However we currently have no method for screening which students are less likely to succeed using a distance modality.    It is clear that, in the six academic years shown, the passing rates are generally decreasing regardless of delivery mode.  We hypothesize that this overall trend is mostly the result of the economic collapse of 2008 which led to increased enrollment and changes in our student demographics \fixthis{REF to diversity section?}.  But the pass rates in DL courses are as much as 30\% lower than in face-to-face counterparts and this large discrepancy needs to be addressed.

\fixthis{the labeling of subfigures is confusing. The labels for a, b, and c are low and at first glance appear to apply to graphs d, e, and f}
\begin{figure}[!htb]
  \begin{widepage}
...
\fixthis{cite outside sources? http://physics.wku.edu/~bonham/Publications/HomeworkCompare.pdf, http://www.d.umn.edu/math/Technical%20Reports/Technical%20Reports%202007-/TR%202011/TR_2011_2.pdf, http://www-rohan.sdsu.edu/~ituba/math3cw03/webworkfocus.pdf
}
