...
\recommendation[Scheduling, DOIs, PCC Cabinet]{All computerized classrooms
...
\recommendation[PCC Cabinet, DOSs, SLCs]{The college should strive for more
...
\recommendation[PCC Cabinet, DOSs, Advising]{All four campuses should have an
...
\recommendation[PCC Cabinet, DOSs, Testing Centers]{We recommend that make-up
