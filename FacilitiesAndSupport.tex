...
\recommendation[Scheduling, DOIs, PCC cabinet]{All computerized classrooms should have at least 30, if not 34, individual work
stations.}

\recommendation[Multimedia, DOIs, PCC cabinet]{An adequate number of classrooms on all campuses should be equipped with
...
\recommendation[Multimedia, TSS]{The disk image for all computerized classrooms should include software that
...
\recommendation[FDCs]{A broader education campaign should be engaged to distribute information to
...
The clerical and administrative setup at Southeast has changed, as of Winter 2014. There was a recent restructuring of divisions. What used to be the Liberal Arts and Sciences Division split into two divisions: the Liberal Arts and CTE Division (which is in the first floor of Scott Hall, Room 103, where the Liberal Arts and Sciences used to be) and the Math and Science Division (which is on the \nth{2} floor of the new Student Commons Building, Room 214). All of the math and science faculty are now in this new space, including the part-time instructors (everybody was scattered before, so this is a welcome change).
...
\recommendation[PCC cabinet, DOSs, DOIs, SLCs]{The college should strive for more consistency with its Student Learning Centers. We feel that the centers would be an even greater resource if they were more consistent in structure, resource
...
\recommendation[PCC cabinet, DOSs, Advising]{All four campuses should have an official advising liaison and the
...
\recommendation[Math SAC, Advising, ROOTS]{ A committee consisting of advisers, math faculty, and other relevant parties
...
\recommendation[PCC cabinet, DOSs, Testing Centers]{We recommend that make-up testing be available as late as 9:00 {\sc p.m.}\ at least two days per week, and that make-up testing hours be available every Saturday.}
