...
also be used to solicit student feedback in an amomynous manner.  The gathering
...
\begin{enumerate}[label=Q\arabic*.,font=\bf]
  ...
  \item We found that nearly 70\% of instructors include resource information
    ...
    We found that students are using external educational websites such as Khan
    Academy, PatrickJMT, PurpleMath, and YouTube.  The data suggest online
...
Learning Centers have been greatly affected by this. (Heiko has a data table
for this in the appendix\fixthis{not sure which part this is supposed to
reference}.) Most notably, the number of students seeking math tutoring has
...
As mentioned in two other places in the program review \fixthis{(REF REF REF)},
...
typically dependent on the room that is assigned for the class.  This has led
...
for their sections raised to 30 or even 35 students. \fixthis{reference class
size in appendix?}
