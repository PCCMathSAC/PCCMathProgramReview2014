...
attendance; the attendance has since steadily grown and  was up to
...
restructuring the space. Since enrollment remains high, having enough space
...
as well as a heightened solicitation for volunteer tutors. Additionally, many
...
\fixthis{page 62, same paragraph, last sentence:  It is not clear from this wording whether the online instructors choose to raise the online class size limits or whether this happened to them.  That difference is HUGE.  Which is it?}
