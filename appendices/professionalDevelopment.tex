...
\begin{description}
	...
	\item[Daniel Castleton (Full-time Instructor, Cascade Campus)]
	...
	\LaTeX.  The course (MTH 84) is described in \fixthis{reference}. Presenting
	...
	developers on new features for WeBWorK (see \fixthis{reference}).  I returned
