...
\fixthis{Are these hours tutoring any subject, or just math?? ask: it would seem so, given the new table. Can we get all four graphs on the same page?}
...
%If I try to rotate this table as I did with earlier sideways tables, some subsequent pages in subsequent appendices are sideways too...
