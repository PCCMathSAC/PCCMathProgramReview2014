...
\fixthis{using multicols seems better, since without it there is too much erratic wasted white space. It looks better to with a wide page, but perhaps has text that gets too close to the margins. also there is a problem in the headers on even pages in a wide page: the header gets cut off. thoughts?}
%\begin{widepage}
%\begin{multicols*}{2}
