...
\fixthis{using multicols seems better, since without it there is too much erratic wasted white space. It looks a lot better with a wide page. *but* there is a problem in the headers on even pages in a wide page: the header gets cut off}
\begin{widepage}
\begin{multicols*}{2}
